(function($){
  ...
  var makeOptions = function(options, $el) {
    ...
    var defaults = {
      options: {
        street1: { id: 'street1', label: 'Street 1', defaultValue: '', enabled: true, cssClass: 'street1', separator: '' },
        street2: { id: 'street2', label: 'Street 2', defaultValue: '', enabled: true, cssClass: 'street2', separator: '' },
        street3: { id: 'street3', label: 'Street 3', defaultValue: '', enabled: true, cssClass: 'street3', separator: '' },
        ...
        country: { id: 'country', label: 'Country', defaultValue: '', enabled: true, cssClass: 'country', separator: '' }
      }
    };
